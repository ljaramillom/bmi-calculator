...
export class ResultadoComponent implements OnInit { bmi: number;
  resultado: string;
  ...
  getResultado() {
    if(this.bmi >=25) {
      ...
      this.interpretacion = 'Tienes un peso corporal superior al normal. Te recomendamos realizar más ejercicio.'
